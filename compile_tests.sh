...
make clean
cd tests/
gcc -o easy.out -Wall -Wextra -Werror test_easy.c ../libft.a munit/munit.c strlcat.c strnstr.c
gcc -o hard.out -Wall -Wextra -Werror test_hard.c ../libft.a munit/munit.c strlcat.c strnstr.c
